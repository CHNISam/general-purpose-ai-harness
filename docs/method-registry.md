...
| Escaping inherited solution frames / design fixation | Jansson & Smith, “Design fixation” — https://doi.org/10.1016/0142-694X%2891%2990003-F | Recognize that prior examples, concepts, and incumbent solutions can constrain conceptual design; use reframing / counterfactual operators when the current representation may be limiting the solution space. |
| Systematic reuse / commonality and variability | CMU SEI, Software Product Lines — https://www.sei.cmu.edu/library/a-framework-for-software-product-line-practice-version-50/ | Move from opportunistic component reuse toward planned reuse of common core assets with explicit variability; useful when deciding what a project should own versus inherit from a broader baseline. |
